  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.subtitle}>测试版本4 - Victory图表</Text>
        
        <View style={styles.card}>
          <Text style={styles.cardTitle}>📊 图表测试</Text>
          <Text style={styles.cardText}>下方应该显示一个柱状图</Text>
          <VictoryChart
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>说明Victory工作正常 ✅</Text>
          <Text style={styles.cardText}>可以继续测试版本5</Text>
        </View>

        <View style={styles.card}>
          <Text style={styles.cardTitle}>❌ 如果应用崩溃</Text>
          <Text style={styles.cardText}>说明Victory有问题</Text>
          <Text style={styles.cardText}>可能需要替换图表库</Text>
        </View>
