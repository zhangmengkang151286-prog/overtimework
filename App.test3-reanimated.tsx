  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.subtitle}>测试版本3 - Reanimated</Text>
        
        <Animated.View style={[styles.card, animatedStyle]}>
          <Text style={styles.cardTitle}>✨ 动画测试</Text>
          <Text style={styles.cardText}>这个卡片应该在闪烁</Text>
          <Text style={styles.cardText}>如果看到动画效果，说明Reanimated工作正常</Text>
        </Animated.View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>说明Reanimated工作正常 ✅</Text>
          <Text style={styles.cardText}>可以继续测试版本4</Text>
        </View>

        <View style={styles.card}>
          <Text style={styles.cardTitle}>❌ 如果应用崩溃</Text>
          <Text style={styles.cardText}>说明Reanimated有问题</Text>
          <Text style={styles.cardText}>这是最常见的崩溃原因</Text>
        </View>
